 ...
 * @Id $Id:: Usu_Init.php 66 2009-05-25 13:45:39Z Rob                  $:  Full Details   
 */
  ...
  @define('SEO_CHAR_CONVERT_SET', ''); //Like: a=>b,g=>z,h=>y
  ...
  @define('SEO_REMOVE_ALL_SPEC_CHARS', 'false'); // Recommended false
  ...
  @define('SEO_ADD_CPATH_TO_PRODUCT_URLS', 'true');
