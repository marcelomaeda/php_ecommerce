 ...
 * @Id $Id:: Usu_Categories.php 92 2009-10-07 11:46:19Z Rob            $:  Full Details   
 */
     ...
     */
     ...
     switch( true ){
       case $page == self::FILENAME:
         $url = $this->linkCreate( self::FILENAME, normalize_special_characters($link_text), self::MARKER, $valuepair[1] );
         break;
       default:
